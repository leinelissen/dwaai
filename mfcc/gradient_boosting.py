...
for learning_rate in lr_list:
    gradient_booster_classifier = GradientBoostingClassifier(n_estimators=20, learning_rate=learning_rate, max_features=120, random_state=10)
    ...
    gradient_booster__evaluation_classifier = GradientBoostingClassifier(n_estimators=20, learning_rate=learning_rate, max_features=120, random_state=10)
